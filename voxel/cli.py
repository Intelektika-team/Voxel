...
"""
                    # Автогенерация конфигурационного .voxel файла.
                    with open('init.voxel', 'w') as file:
                        file.write(dotvoxel)
                        print(i.color.set("Language file 'init.voxel' created successfully.", i.color.YELLOW))
